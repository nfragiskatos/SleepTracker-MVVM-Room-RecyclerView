...
class SleepQualityFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        // Get the arguments that came with the navigation when coming here from Sleep Quality fragment.
        val arguments = SleepQualityFragmentArgs.fromBundle(arguments!!)

        val sleepDatabaseDao = SleepDatabase.getInstance(application).sleepDatabaseDao

        val viewModelFactory = SleepQualityViewModelFactory(arguments.sleepNightKey, sleepDatabaseDao)
